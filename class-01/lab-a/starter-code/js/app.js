...
function displayPics(){
  ...
  // rando is declared with const keyword, the scope is et to the while block where it is declared. so the rando varaible is not available outside the while block
  console.log(viewed);
